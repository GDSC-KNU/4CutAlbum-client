...
interface FourCutsRepository {
    ...
    suspend fun updateFourCuts(title: String?, photo: Uri, friends: List<String>?, place: String?, comment: String?, public_yn: String, people: Int?, hashtag: List<String>?, feed_id: String?, id: Int)
